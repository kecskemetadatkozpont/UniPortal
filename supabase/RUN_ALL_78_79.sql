-- ============================================================================
-- RUN_ALL_78_79.sql — határidőnaptár + kutatói profil (2026-09-24)
-- ============================================================================
-- Ezt kell lefuttatni a Supabase SQL Editorban. Újrafuttatható.
--
--   78_grants_calendar.sql     — a Pályázatfigyelő „Határidőnaptár" füle
--        (grants_deadlines, grants_deadline_months). Ha a 78-ast már
--        lefuttattad, ez a rész nem változtat semmit.
--   79_grants_researchers.sql  — KUTATÓI PROFIL: kutatói törzs, publikációk,
--        témaprofil, kompetenciák és az azonosító-összekötési javaslatok.
--        Az összekötés kézi döntés, kivéve az ORCID-egyezést.
...
--
-- Utána a felületen semmi új nem látszik még: a kutatói képernyő és az
-- OpenAlex-betöltő a következő körben készül el. A 79-es az adatbázis-oldalt
-- teszi le, amire azok épülnek.
-- ============================================================================
