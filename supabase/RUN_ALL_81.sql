-- ============================================================================
-- RUN_ALL_81.sql — a hiányzó MTMT forrássor (2026-09-24)
-- ============================================================================
-- RÖVID fájl, egyetlen hiba javítása. A 78-80 már lefutott; ez pótolja azt a
-- forrássort, ami nélkül az MTMT-felderítés GRANTS_SOURCE_NOT_FOUND hibával
-- elhasal. A 77-esbe `mta` kóddal az Akadémia PÁLYÁZATAI kerültek be, az MTMT
-- publikációs adatbázis pedig kimaradt — a 80-as update-je ezért nulla sort
-- módosított.
--
-- A FUTÁS VÉGÉN EZT KELL LÁTNOD:
--   NOTICE: Rendben: 81 — MTMT forrassor megvan, es mind a 8 forraskod letezik.
--
-- Utána az MTMT-felderítés (306 szerző) betölthető.
-- ============================================================================
