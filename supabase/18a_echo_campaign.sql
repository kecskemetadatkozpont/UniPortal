...
-- felev vegi ertekeles, kulon meroeszkoz egy karnak). Amelyik kampanyra ket
-- kerdoivet kap egy hallgato, az szandekos: az echo_my_courses() soronkent
-- adja a campaign_id-t, es a felulet kampanynevvel kulonbozteti meg oket.
