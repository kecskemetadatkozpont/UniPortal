-- ============================================================================
-- RUN_ALL_53.sql — UniPortal
--
--   53_dorm_status.sql   szoba- és férőhely-állapot váltása, indoklással
--   + a végén a MODUL SAJÁT ELLENŐRZÉSE
--
-- ELŐFELTÉTEL: a RUN_ALL_52.sql már lefutott (a dorm.can_edit_inventory()
-- onnan származik). Idempotens, adatot nem módosít.
-- ============================================================================
