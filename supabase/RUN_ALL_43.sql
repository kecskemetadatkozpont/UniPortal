-- ============================================================================
-- RUN_ALL_43.sql — UniPortal
--
--   43_course_registry.sql     kurzusnyilvántartás (metaadat, oktatók, névsor, fájlok)
--   21_echo_harden_submit.sql  ÚJRA — minden új migráció után kötelező
--   + a végén a MODUL SAJÁT ELLENŐRZÉSE
--
-- ELŐFELTÉTEL: a RUN_ALL_42.sql már lefutott.
-- Idempotens. Meglévő kurzust és beiratkozást nem módosít.
-- ============================================================================
