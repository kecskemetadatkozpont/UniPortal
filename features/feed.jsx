...
function FEED_seed() {
  ...
  return [
    { id: 'FP-earlybird', type: 'promo', title: 'Early Bird 2026 — 15% tuition discount', body: 'Apply and pay your application fee before 30 April 2026 to lock in a 15% discount on your first-year tuition. Applies to all English-taught bachelor and master programmes.', image_url: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1200&q=70', gallery: null, author_name: 'Admissions Office', pinned: true, promo_code: 'EARLYBIRD15', discount: '15% off tuition', event_date: d(60), event_location: null, capacity: null, ticket_code: null, cta_label: 'Browse programmes', cta_href: '', created_at: back(1) },
